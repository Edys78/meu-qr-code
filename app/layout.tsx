...
export const metadata: Metadata = {
  ...
  description: 'Plataforma completa para criação, personalização avançada com logotipo e molduras, rastreamento de links dinâmicos e geração de PIX com chave e valor.',
  icons: {
    icon: [
